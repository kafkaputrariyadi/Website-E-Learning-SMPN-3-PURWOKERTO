                        ...
                        <div class="pilihan-list">
                            ${soal.pilihan
                              .map((p) => {
                                ...
                                const isCorrect = isCorrectAnswer && soal.benar;
                                const isWrong = isCorrectAnswer && !soal.benar;
                                return `
...
function renderPenilaianList() {
  ...
  // Setup listener untuk tab buttons yang baru dibuat
  ...
  renderTugasListContent(); // Tampilkan konten list default
}
...
function renderTugasListContent() {
  ...
  if (currentTab === "belum-dinilai") {
    const belumDinilai = tugasData.filter((t) => t.status === "Belum Dinilai");
    ...
    const sudahDinilai = tugasData.filter((t) => t.status === "Sudah Dinilai");
    ...
    listContainer.innerHTML = `
            <div style="display: grid; grid-template-columns: 1fr 350px; gap: 20px;">
                ...
                <div>
                    ...
                    <div class="deadline-card"><h3>Pengingat Deadline</h3><div class="deadline-item">📌 Pr Kelas 7A Daily Activities berakhir dalam 3 hari</div><div class="deadline-item">📌 Pr Kelas 7B Daily Activities berakhir dalam 5 hari</div></div>
                </div>
            </div>
        `;
  }
